  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        luxury:
          "bg-gradient-to-r from-[#9e7552] via-[#b68f6d] to-[#9e7552] text-white shadow-lg shadow-[#9e7552]/25 hover:shadow-xl hover:shadow-[#9e7552]/35 hover:brightness-105 border border-[#dfb793]/30",
      },
      size: {
        default: "h-11 px-5 py-2",
        sm: "h-9 rounded-lg px-3.5 text-xs",
        lg: "h-13 rounded-2xl px-8 text-base tracking-wide font-semibold",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
